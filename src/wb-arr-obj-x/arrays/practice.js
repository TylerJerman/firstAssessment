...
function divider(numbersArray){
  let  evens = [2, 34, 54, 32, 66];
  let odds = [1, 55, 11, 19, 17, 13]
  return arr.numbersArray + evens + odds 
}
////////// PROBLEM 7 //////////
...
//Code Here
function maker() {
  return Array.from({ length: 215 }, (_, index) => index + 1);
}
